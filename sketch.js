...
function preload() {
  receipt = loadImage('https://raw.githubusercontent.com/ngantran-azure/Randomizer101/main/assets/a%20receipt.png');
  cupstraw = loadImage('https://raw.githubusercontent.com/ngantran-azure/Randomizer101/main/assets/cup%20straw.png');
  cuplid = loadImage('https://raw.githubusercontent.com/ngantran-azure/Randomizer101/main/assets/cup%20lid.png');

  for(let i = 0; i <= 6 ; i++) {
    flv[i] = loadImage(`https://raw.githubusercontent.com/ngantran-azure/Randomizer101/main/assets/flv${i}.png`)
  };

  for(let n = 0; n<=5; n++) {
    toppy[n] = loadImage(`https://raw.githubusercontent.com/ngantran-azure/Randomizer101/main/assets/top${n}.png`)
  }
